...
// A tabela de contas de ANTES do painel repaginado (17/09/2026). Fica
// como reserva: a tela Contas volta para ela quando a migração 123 ainda
// não foi reaplicada no banco. O editor de assinatura mora em
// EditorAssinatura.tsx.
...
import { agoraDasContas, definirBanimento, definirContaDaCasa } from "../actions";
import { EditorAssinatura, type OpcaoDePlano } from "./EditorAssinatura";
    ...
    >
      ...
      {editando && (
        <EditorAssinatura
          ...
          atual={
            a
              ? { plano: a.plano, valorMensal: a.valorMensal, status: a.status, observacao: a.observacao }
              : null
          }
          planos={planos}
