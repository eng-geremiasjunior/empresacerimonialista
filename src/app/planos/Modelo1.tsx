...
// MODELO 1 (23/09/2026): a página de vendas anterior, guardada em
// /planos?modelo=1 depois que o dono trocou a padrão pelo desenho novo
// (SiteModelo2). O page.tsx decide qual das duas mostrar.
...
export async function PlanosModelo1() {
