...
// Calendário, Catálogo, Contratos e Agenda de Fornecedores saíram do menu
// SEM sair do sistema: viraram visões da tela que os explica (Eventos,
// Gestão comercial, Fornecedores — ver lib/visoes.ts). As rotas não
// mudaram; o item-mãe fica ativo nelas (TAMBEM_ATIVO).
//
// A Assinatura também tinha saído (15/09, para dentro de Configurações) e
// VOLTOU em 16/09/2026, abaixo de Financeiro: escondida, ninguém achava
// onde assinar — e é por ela que quem está no teste grátis vira
// assinante (dono).
const NAV: NavItem[] = [
  ...
  {
    // quem decide o plano é a proprietária; a tela recusa os outros cargos
    label: "Assinatura",
    icon: "assinatura",
    href: "/assinatura",
    cargos: ["proprietaria"],
