...
// Vela: quem lê aqui não precisa mandar mensagem perguntando.
//
...
export const GRUPOS_AJUDA: GrupoAjuda[] = [
  {
    ...
    perguntas: [
      ...
      },
      {
        ...
        resposta:
          "Em Configurações, na seção da empresa (aparece para a proprietária). A logo e o nome saem na proposta, no PDF e no portal da cliente — é a sua marca na frente do casal, não a do Vela.",
      },
    ],
  },
  {
