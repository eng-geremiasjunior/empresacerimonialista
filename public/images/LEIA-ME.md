...
|---|---|---|
| `hero-padrao.jpg` | Fundo do topo da proposta (`HeroApresentacao`) | horizontal, ~1600×1000 |
| `no-dia-evento-padrao.jpg` | Ao lado das responsabilidades (`NoDiaDoEvento`) | ~1000×700 |
